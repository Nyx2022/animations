...
<div>
  ...
  <div class="my-4 grid gap-2">
    <ul class="list-disc list-inside space-y-2 text-muted-foreground">
      ...
      <li>
        <span class="text-primary font-mono">blurIn</span> - Blur from blurred to
        clear
      </li>
      <li>
        <span class="text-primary font-mono">blurInUp</span> - Blur in with upward
        motion
      </li>
      <li>
        <span class="text-primary font-mono">blurInDown</span> - Blur in with downward
        motion
      </li>
      <li>
      ...
      <li>
        <span class="text-primary font-mono">scaleUp</span> - Scale from small to
        normal with spring
      </li>
      <li>
        <span class="text-primary font-mono">scaleDown</span> - Scale from large
        to normal with spring
      </li>
    </ul>
  </div>
  ...
  <div class="my-4 grid gap-2">
    <ul class="list-disc list-inside space-y-2 text-muted-foreground">
      <li>
        <span class="text-primary font-mono">text</span> - Animate the entire text
        as one unit
      </li>
      <li>
        <span class="text-primary font-mono">word</span> - Animate each word separately
        (default)
      </li>
      <li>
        <span class="text-primary font-mono">character</span> - Animate each character
        separately
      </li>
      <li>
        <span class="text-primary font-mono">line</span> - Animate each line separately
        (split by \n)
      </li>
    </ul>
  </div>
